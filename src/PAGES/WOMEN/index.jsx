...
import WomenPageSidebar from "../../COMPONENTS/WomenPageSidebar";
import BestSellers from "../../COMPONENTS/BestSellers";

const WomenProducts = () => {
  const { womenProducts } = globalContext();
        ...
        <div className="lg:col-span-3 bg-white px-2 pt-10 md:px-4 mx-4 lg:px-28">
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-6">
              <p className="text-slate-500">Home / Women</p>
              <h3 className="text-3xl lg:text-6xl">Women</h3>
            </div>
