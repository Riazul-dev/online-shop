...
const Cart_Products = () => {
  ...
  const { cartProducts, removeFromCart, totalPrice, updateCart } = globalContext();
        ...
        <div>
          ...
          <section className="border hidden lg:block">
              ...
              return (
                <div key={product.id} className="grid grid-cols-7 border-b">
                  ...
                  <div className="col-span-5  grid grid-cols-5 place-content-center">
                    ...
                    <div>{(quantity * newPrice).toFixed(2)}</div>
                  </div>
                </div>
              );
            })}
            ...
            <div className="flex flex-col md:flex-row md:justify-between gap-2 px-4 py-4">
              ...
              <div>
                <button
                  // onClick={() => updateCart({product, updateQuantity})}
                  className="bg-blue-500 w-full py-2.5 md:px-6 text-white text-sm"
                >
                  UPDATE CART
                </button>
              </div>
