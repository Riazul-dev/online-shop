...
const EverythingPageSidebar = () => {
  const [sliderValue, setSliderValue] = useState([50, 300]);
  const { menProducts, womenProducts, Accessories, FilteredEverythingProducts } = globalContext();
    ...
    <>
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex justify-between items-center">
          <button
            onClick={() => FilteredEverythingProducts(sliderValue)}
...
export default EverythingPageSidebar;
